...
void vInitialiseTimerForIntQueueTest( void )
{
	...
	LPC_CT16B0->MR0 = SystemCoreClock / tmrTIMER_2_FREQUENCY;
	LPC_CT16B1->MR0 = SystemCoreClock / tmrTIMER_3_FREQUENCY;
